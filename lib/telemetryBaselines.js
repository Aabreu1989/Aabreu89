...
export function consolidatePlatformMetrics(db) {
    ...
    const aiUserQueries     = CANONICAL_AI_METRICS.USER_QUERIES;
    const aiTelemetry       = CANONICAL_AI_METRICS.TELEMETRY;
    const totalAiEvents     = aiUserQueries + aiTelemetry; // 18.668 + 2.062 = 20.730 (Derivado estritamente por soma)
    const aiQueries         = aiUserQueries; // 18.668 (Demanda Humana)
