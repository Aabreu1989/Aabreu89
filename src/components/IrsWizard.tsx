...
const LOCAL_TRANS: Record<string, Record<string, string>> = {
    ...
    en: {
        ...
        jovem_desc: "• **How it works**: Tax benefit for young workers aged 18 to 35 earning Category A or B income (2026 reform extended up to 10 years of activity).\n• **Annexes**: **Model 3 (Manual), Face Sheet Box 4, and Annex A** (Box 4F where you declare your tax exemption).\n• **Progressive Benefit (Up to 10 years)**: Tax exemption of:\n  - 100% in year 1 (limit 55x IAS)\n  - 75% in years 2 to 4\n  - 50% in years 5 to 7\n  - 25% in years 8 to 10\n• **Warning**: IRS Jovem is NOT automatic. Confirming automatic IRS without manual Annex A configuration yields standard taxation, losing your benefits!",
    ...
    br: {
        ...
        jovem_desc: "• **Como Funciona**: Benefício para jovens dos 18 aos 35 anos que recebam rendimentos de Categoria A ou B (regime 2026 estendido até 10 anos de atividade).\n• **Anexos**: **Modelo 3 (Manual), Quadro 4 da Folha de Rosto e Anexo A** (Quadro 4F — onde se declara o benefício).\n• **Benefício Progressivo (até 10 anos)**: Isenção de IRS de:\n  - 100% no 1.º ano (limite de 55x IAS)\n  - 75% do 2.º ao 4.º ano\n  - 50% do 5.º ao 7.º ano\n  - 25% do 8.º ao 10.º ano\n• **Atenção**: O IRS Jovem NÃO é automático. Se submeter o IRS Automático sem preencher o Anexo A manualmente, perderá o direito ao desconto fiscal desse ano!",
    ...
    es: {
        ...
        jovem_desc: "• **Cómo Funciona**: Beneficio para jóvenes de 18 a 35 años con rentas de Categoría A o B (reforma 2026 extendida hasta 10 años de actividad).\n• **Anexos**: **Modelo 3 (Manual), Cuadro 4 de la Hoja de Portada y Anexo A** (Cuadro 4F — donde se declara el beneficio).\n• **Beneficio Progresivo (hasta 10 años)**: Exención de IRS de:\n  - 100% en el 1.er año (límite de 55x IAS)\n  - 75% del 2.º al 4.º año\n  - 50% del 5.º al 7.º año\n  - 25% del 8.º al 10.º año\n• **Atención**: ¡El IRS Jovem NO es automático! Si presenta el IRS Automático sin rellenar el Anexo A manualmente, perderá el derecho al descuento fiscal ese año.",
