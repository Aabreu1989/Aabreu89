...
export async function generateAdminHubPDF(data: AuditPlatformData): Promise<void> {
  ...
  autoTable(doc, {
    ...
    body: [
      ...
      ['Retorno & Aderência de Uso', `${weightedRetentionRateVal}%`, 'Modelo Ponderado Canónico (public.activity_logs)', 'Tempo Real'],
  ...
  autoTable(doc, {
    ...
    body: isEn
      ? [
          ...
          ['Return & Usage Adherence Rate', `${retentionVal}`, 'public.activity_logs (canonical actions >=30m / UTC)', 'Real-Time'],
      ...
      : [
          ...
          ['Retorno & Aderência de Uso', `${retentionVal}`, 'public.activity_logs (ações canónicas ≥30m / UTC)', 'Tempo Real'],
  ...
  autoTable(doc, {
    ...
    body: isEn
      ? [
          ...
          ['TOTAL', 'Consolidated Human Demand', 'MIRA Ecosystem', aiLiveVal, '100.0%'],
        ]
      : [
          ...
          ['TOTAL', 'Demanda Humana Consolidada', 'Ecossistema MIRA', aiLiveVal, '100,0%'],
        ],
...
export async function generateAuditExcel(
  ...
  const aiRows: any[][] = [
    ...
    ['TOTAL', 'Demanda Humana Consolidada', 'Ecossistema MIRA', 18668, '100.0%'],
  ];
