...
// 🛡️ [MIRA V3.1M] LOCAL KNOWLEDGE BASE - Funciona SEM API (Custo €0)const MIRA_LOCAL_KB: Record<string, string> = {
  ...
  'empresa': '👔 RESPONSABILIDADE DAS EMPRESAS NA CONTRATAÇÃO DE ESTRANGEIROS (DIRETRIZES 2025/2026):\n\nAs empresas em Portugal só podem contratar trabalhadores estrangeiros mediante prévia obtenção de Visto de Trabalho (D1) no Consulado de origem ou Visto de Procura de Trabalho. O contrato assinado em Portugal não serve para regularizar turistas (Art. 88 extinto). A empresa deve emitir a Promessa de Contrato e inscrever o trabalhador na Segurança Social sob pena de sanções severas da ACT.\n[view:JOBS:Ver Vagas de Emprego]',
  'empresas': '👔 RESPONSABILIDADE DAS EMPRESAS NA CONTRATAÇÃO DE ESTRANGEIROS (DIRETRIZES 2025/2026):\n\nAs empresas em Portugal só podem contratar trabalhadores estrangeiros mediante prévia obtenção de Visto de Trabalho (D1) no Consulado de origem ou Visto de Procura de Trabalho. O contrato assinado em Portugal não serve para regularizar turistas (Art. 88 extinto). A empresa deve emitir a Promessa de Contrato e inscrever o trabalhador na Segurança Social sob pena de sanções severas da ACT.\n[view:JOBS:Ver Vagas de Emprego]',
  'termo de responsabilidade': '📄 TERMO DE RESPONSABILIDADE EMPRESARIAL / ALOJAMENTO (2025/2026):\n\n1. TERMO DE RESPONSABILIDADE DA EMPRESA: A empresa contratante em Portugal pode emitir um Termo de Responsabilidade para comprovar meios de subsistência e alojamento no Consulado, facilitando a emissão do Visto D1 ou Visto de Procura de Trabalho.\n2. TERMO DE RESPONSABILIDADE DE ALOJAMENTO: Emitido por cidadão residente legal em Portugal com caderneta predial ou contrato de arrendamento válido registado nas Finanças.\n[view:DOCUMENT_ASSISTANT:Gerar Minuta de Termo de Responsabilidade]',
  'promessa de trabalho': '📜 PROMESSA DE CONTRATO DE TRABALHO PARA VISTO CONSULAR (D1):\n\nA Promessa de Contrato de Trabalho emitida por empresa sediada em Portugal é o documento essencial submetido ao Consulado Português do país de origem para instrução do Visto D1 (Trabalho Subordinado). Deve conter a identificação da empresa, função, remuneração (mínimo 870€/mês) e compromisso de contratação.\n[view:DOCUMENT_ASSISTANT:Gerar Minuta de Promessa de Contrato]',
