...
const MIRA_LOCAL_KB: Record<string, string> = {
  ...
  'irs': 'O MIRA possui uma Calculadora de IRS automática para simular a retenção na fonte e o imposto a pagar ou a receber em Portugal.',
