...
let _currentKbVersion = '0';// 🛡️ [MIRA V3.1M] LOCAL KNOWLEDGE BASE - Funciona SEM API (Custo €0)
const MIRA_LOCAL_KB: Record<string, string> = {
  ...
  'procura de trabalho': '🔍 VISTO PARA PROCURA DE TRABALHO (120 + 60 DIAS):\nPermite viajar legalmente para Portugal para procurar emprego. Requisitos: Inscrição com declaração de manifestação de interesse de oferta no IEFP, passagem de regresso (ou termo de responsabilidade) e meios de subsistência (3x Salário Mínimo = 2.760€ ou termo de responsabilidade de cidadão/empresa residente).\n[view:JOBS:Ver Vagas de Emprego]',
  'visto procura de trabalho': '🔍 VISTO PARA PROCURA DE TRABALHO (120 + 60 DIAS):\nPermite viajar legalmente para Portugal para procurar emprego. Requisitos: Inscrição com declaração de manifestação de interesse de oferta no IEFP, passagem de regresso (ou termo de responsabilidade) e meios de subsistência (3x Salário Mínimo = 2.760€ ou termo de responsabilidade de cidadão/empresa residente).\n[view:JOBS:Ver Vagas de Emprego]',
