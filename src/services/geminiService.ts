...
export const MIRA_LOCAL_KB: Record<string, string> = {
  'nav': '⚖️ GUIA: O QUE FAZER SE RECEBER UMA NAV (AIMA / LEI DE ESTRANGEIROS 2026):\n\nUma NAV pode ter dois significados formais no processo de imigração:\n\n1. NOTIFICAÇÃO DE AUDIÊNCIA PRÉVIA (Art. 121.º do CPA):\n• O que significa: A AIMA notifica a intenção de indeferir o teu pedido de residência/renovação antes de tomar uma decisão final.\n• Prazo Legal: Tens 10 DIAS ÚTEIS para responder e juntar os documentos em falta.\n• Ação Imediata: Identifica o motivo apontado (ex.: meios de subsistência, contrato, registo criminal) e submete uma pronúncia por escrito com as provas necessárias.\n\n2. NOTIFICAÇÃO PARA ABANDONO VOLUNTÁRIO (Art. 138.º da Lei 23/2007):\n• O que significa: Notificação para deixar o país voluntariamente no prazo fixado (habitualmente de 10 a 20 dias).\n• Risco: O não cumprimento gera processo de afastamento coercivo (expulsão) com interdição de reentrada no Espaço Schengen por 3 a 5 anos.\n• Ação Imediata: Contactar com máxima urgência apoio jurídico especializado (CNAIM, CLAIM ou Advogado) para avaliar impugnação judicial no TAC com efeito suspensivo.\n\n💡 RECOMENDAÇÃO MIRA: Nunca deixes o prazo passar sem resposta formal.\n[view:LOCAL_SERVICES:Ver Balcões CNAIM e Apoio Jurídico] [view:DOCUMENT_ASSISTANT:Gerar Minutas em PDF]',
  'audiencia previa': '⚖️ AUDIÊNCIA PRÉVIA AIMA (Art. 121.º do CPA):\nSe recebeste uma Notificação de Audiência Prévia da AIMA, tens 10 DIAS ÚTEIS para apresentar a tua defesa e juntar os documentos exigidos antes de uma decisão final. Submete a tua resposta por escrito com os comprovativos.\n[view:LOCAL_SERVICES:Ver Apoio Jurídico CNAIM] [view:DOCUMENT_ASSISTANT:Gerar Minutas]',
  'audiência prévia': '⚖️ AUDIÊNCIA PRÉVIA AIMA (Art. 121.º do CPA):\nSe recebeste uma Notificação de Audiência Prévia da AIMA, tens 10 DIAS ÚTEIS para apresentar a tua defesa e juntar os documentos exigidos antes de uma decisão final. Submete a tua resposta por escrito com os comprovativos.\n[view:LOCAL_SERVICES:Ver Apoio Jurídico CNAIM] [view:DOCUMENT_ASSISTANT:Gerar Minutas]',
  'abandono voluntario': '⚠️ NOTIFICAÇÃO PARA ABANDONO VOLUNTÁRIO (Art. 138.º da Lei 23/2007):\nFixa um prazo (habitualmente 10 a 20 dias) para saída voluntária. O não cumprimento pode originar decisão de expulsão e interdição no Espaço Schengen de 3 a 5 anos. Procura apoio jurídico urgente no CNAIM/CLAIM para verificar possibilidade de recurso com efeito suspensivo.\n[view:LOCAL_SERVICES:Ver Balcões CNAIM / CLAIM]',
  'abandono voluntário': '⚠️ NOTIFICAÇÃO PARA ABANDONO VOLUNTÁRIO (Art. 138.º da Lei 23/2007):\nFixa um prazo (habitualmente 10 a 20 dias) para saída voluntária. O não cumprimento pode originar decisão de expulsão e interdição no Espaço Schengen de 3 a 5 anos. Procura apoio jurídico urgente no CNAIM/CLAIM para verificar possibilidade de recurso com efeito suspensivo.\n[view:LOCAL_SERVICES:Ver Balcões CNAIM / CLAIM]',
  ...
  'morada falsa': '⛔ ALERTA LEGAL & RECUSA CATEGÓRICA A FRAUDE (Art. 256.º do Código Penal):\nO MIRA não apoia, não orienta e recusa terminantemente qualquer prática de utilização ou aluguer de moradas falsas, moradas de fachada ou atestados de conveniência. A prestação de falsas declarações ou falsificação de documentos perante a AIMA, Autoridade Tributária ou Juntas de Freguesia consubstancia crime de falsificação de documentos punível com pena de prisão (Artigo 256.º do Código Penal) e cancelamento imediato de processos de regularização.',
  'comprar vaga': '⛔ ALERTA ANTI-FRAUDE — ESQUEMAS ILEGAIS DE MARCAÇÃO AIMA:\nO MIRA recusa categoricamente qualquer envolvimento na compra, venda ou intermediação de vagas ou agendamentos da AIMA. A comercialização de agendamentos é ilícita e sujeita a investigação criminal. Os agendamentos oficiais na AIMA são estritamente gratuitos e pessoais através dos canais do Estado (aima.gov.pt ou linha telefónica oficial). Procure apoio gratuito oficial nos centros CNAIM/CLAIM.\n[view:LOCAL_SERVICES:Ver Balcões Oficiais CNAIM]',
  'comprar agendamento': '⛔ ALERTA ANTI-FRAUDE — ESQUEMAS ILEGAIS DE MARCAÇÃO AIMA:\nO MIRA recusa categoricamente qualquer envolvimento na compra, venda ou intermediação de vagas ou agendamentos da AIMA. A comercialização de agendamentos é ilícita e sujeita a investigação criminal. Os agendamentos oficiais na AIMA são estritamente gratuitos e pessoais através dos canais do Estado (aima.gov.pt ou linha telefónica oficial). Procure apoio gratuito oficial nos centros CNAIM/CLAIM.\n[view:LOCAL_SERVICES:Ver Balcões Oficiais CNAIM]',
  'contrato falso': '⛔ ALERTA LEGAL & RECUSA DE PRÁTICA ILÍCITA (Art. 256.º do Código Penal):\nO MIRA recusa liminarmente qualquer colaboração ou redação de contratos de trabalho simulados ou fictícios. A simulação de vínculos laborais para instrução perante a AIMA constitui crime de falsificação de documentos (Artigo 256.º do Código Penal) e ilícito da Lei de Estrangeiros, acarretando processo-crime e anulação dos pedidos.',
...
export const MIRA_LOCAL_KB_EN: Record<string, string> = {
  'nav': '⚖️ GUIDE: WHAT TO DO IF YOU RECEIVE A NAV IN PORTUGAL (2026):\n\nA NAV notification usually refers to one of two critical legal procedures:\n\n1. NOTIFICATION OF PRIOR HEARING (Art. 121 CPA):\n• Meaning: AIMA intends to reject your residence permit/renewal unless you provide missing documents or clarifications.\n• Deadline: You have 10 BUSINESS DAYS to submit your formal written response and evidence.\n\n2. NOTIFICATION FOR VOLUNTARY DEPARTURE (Art. 138 Law 23/2007):\n• Meaning: Official notice giving you 10 to 20 days to leave Portugal voluntarily.\n• Warning: Failing to comply or appeal leads to mandatory deportation and a 3 to 5-year Schengen ban.\n• Immediate Action: Seek urgent legal counsel from CNAIM/CLAIM or an immigration lawyer to file an appeal with suspensive effect.\n\n[view:LOCAL_SERVICES:View Support Desks CNAIM/CLAIM] [view:DOCUMENT_ASSISTANT:Generate Official Templates]',
...
export const MIRA_LOCAL_KB_ES: Record<string, string> = {
  'nav': '⚖️ GUÍA: QUÉ HACER SI RECIBES UNA NAV EN PORTUGAL (2026):\n\nUna NAV puede referirse a dos procedimientos legales clave:\n\n1. NOTIFICACIÓN DE AUDIENCIA PREVIA (Art. 121 CPA):\n• Significado: AIMA tiene la intención de denegar tu solicitud si no aportas los documentos o alegaciones en el plazo fijado.\n• Plazo: Tienes 10 DÍAS HÁBILES para responder por escrito con las pruebas necesarias.\n\n2. NOTIFICACIÓN PARA SALIDA/ABANDONO VOLUNTARIO (Art. 138 Ley 23/2007):\n• Significado: Plazo oficial (10 a 20 días) para abandonar voluntariamente el país.\n• Advertencia: El incumplimiento genera orden de expulsión con prohibición de entrada en el Espacio Schengen de 3 a 5 años. Acude con urgencia a un centro CNAIM/CLAIM para asesoramiento legal.\n\n[view:LOCAL_SERVICES:Ver Centros de Apoyo CNAIM/CLAIM] [view:DOCUMENT_ASSISTANT:Generar Minutas]',
...
const MIRA_LOCAL_KB_FR: Record<string, string> = {
  'nav': '⚖️ GUIDE : QUE FAIRE SI VOUS RECEVEZ UNE NAV AU PORTUGAL (2026) :\n\nUne NAV correspond généralement à l\'une de ces deux procédures :\n\n1. NOTIFICATION D\'AUDITION PRÉALABLE (Art. 121 CPA) :\n• Signification : L\'AIMA envisage de rejeter votre demande de titre de séjour si vous ne complétez pas votre dossier.\n• Délai : Vous disposez de 10 JOURS OUVRABLES pour transmettre vos justificatifs par écrit.\n\n2. NOTIFICATION DE DÉPART VOLONTAIRE (Art. 138 Loi 23/2007) :\n• Signification : Ordre de quitter volontairement le territoire sous 10 à 20 jours.\n• Risque : Le non-respect entraîne une mesure d\'éloignement forcé et une interdiction de retour dans l\'Espace Schengen de 3 à 5 ans. Consultez d\'urgence un centre CNAIM/CLAIM pour un recours.\n\n[view:LOCAL_SERVICES:Voir les Centres CNAIM/CLAIM] [view:DOCUMENT_ASSISTANT:Générer des Documents]',
...
[view:DOCUMENTS:voluntary_return:Programme de Retour Volontaire (ARVoRE VIII)]`
  ...
  PACOTE_LEGISLATIVO_PROMULGADO_2026: {
    aliases: [
      ...
      'lei de estrangeiros 2026', 'novas regras de imigracao', 'novas regras de imigração', 'novas regras',
      'regras de imigracao', 'regras de imigração', 'mudancas na imigracao', 'mudanças na imigração',
      'novas leis de imigracao', 'novas leis de imigração', 'leis de imigracao', 'leis de imigração',
      'promulgated law', 'new immigration law', 'new immigration rules', 'immigration rules',
...
export const getMiraLocalResponse = (prompt: string, language: string = 'PT', historyLang?: string): string => {
  ...
  const specificPhrases = [
    ...
    'salario liquido', 'salário líquido', 'recibos verdes', 'custo de vida', 'atestado multiuso', 'nav', 'audiencia previa', 'audiência prévia', 'abandono voluntario', 'abandono voluntário'
  ];
