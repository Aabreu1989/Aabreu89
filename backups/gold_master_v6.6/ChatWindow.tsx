    ...
    const handleSendMessage = async (e: React.FormEvent) => {
        ...
        if (isMiraChat) {
            ...
            try {
                ...
                console.log("🎯 [MIRA BRAIN] Response grounded in sources:", aiResponse.sources);
            } catch (err) {
            ...
            <div className="bg-white p-6 pb-4 border-b border-slate-100 flex items-center justify-between sticky top-0 z-10 shadow-sm">
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative">
                        <img 
                            src={otherUser?.avatar || 'https://api.dicebear.com/7.x/avataaars/svg?seed=mira'} 
                            alt="" 
                ...
                {isAiThinking && (
                    <div className="flex flex-col items-start max-w-[85%] animate-pulse">
                        <div className="p-5 rounded-[2.5rem] bg-white text-slate-400 border border-slate-100 rounded-tl-none shadow-sm flex items-center gap-3">
                            <Bot size={16} className="text-[#FF8C00] animate-bounce" />
                            <span className="text-[10px] font-black uppercase tracking-widest">MIRA está a consultar a Soberania...</span>
                        </div>
                    </div>
                )}
