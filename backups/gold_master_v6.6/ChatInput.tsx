...
const ChatInput: React.FC<ChatInputProps> = ({ 
    ...
    return (
        <div data-mira-v="2026.GO-LIVE" className="bg-transparent px-3 py-3 z-[300] safe-area-bottom pointer-events-auto">
            <div className={`w-full max-w-3xl mx-auto flex items-center gap-3 bg-white/95 backdrop-blur-2xl rounded-full px-2.5 py-2.5 shadow-xl border-[1.5px] transition-all duration-500 ${text.trim() ? 'border-mira-orange' : 'border-slate-200'}`}>
                ...
                <button
                    ...
                    className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 flex-shrink-0 active:scale-95 shadow-lg
                        ${text.trim() 
                            ? 'bg-gradient-to-tr from-mira-orange to-orange-400 text-white shadow-orange-500/40' 
