...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log(`--- [MIRA EXPORT IMPACT] NATIVE VERCEL ROUTING ACTIVE ---`);
    ...
    const exportPayload = {
      ...
      award_forms_templates: {
        ...
        EN: {
          social_impact: `MIRA delivered measurable, system-wide social impact in 2026: saving a total of ${activeMetrics.tempo_poupado_horas} hours for migrant citizens, processing and facilitating ${activeMetrics.processos_ajudados} individual immigration procedures, and increasing the perceived public entity transparency index to ${activeMetrics.indice_transparencia}%. We achieved an active user traction base of ${activeMetrics.usuarios_ativos_mensais} Monthly Active Users (MAU) and a procedural procedural resolution success rate of ${activeMetrics.taxa_resolucao_sucesso}%.`,
