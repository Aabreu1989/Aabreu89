-- 
-- 👑 SQL MASTER V12500 - SOBERANIA ABSOLUTA (AMANDA ABREU)
-- OBJETIVO: Consolidação Final de Moderação, Sugestões e Performance.
-- FIX: Restauro de Views de Sugestões, Morte definitiva aos erros de tipo e Cascatas.
--
...
DROP TRIGGER IF EXISTS trg_sync_post_to_ai_v12500 ON public.posts;
CREATE TRIGGER trg_sync_post_to_ai_v12500 AFTER INSERT OR UPDATE OR DELETE ON public.posts FOR EACH ROW EXECUTE FUNCTION public.sync_post_to_ai_v12500();
...
-- ==========================================
-- 5. FUNÇÕES NUCLEARES (MODERAÇÃO E SUGESTÕES)
-- ==========================================
...
-- Eliminação de Sugestões (Restaurada)
